	...
	<form method="post" class="form form-horizontal" id="form-special-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-6 col-sm-6">
				<input type="text" class="input-text" value="<?php echo ($type["type_name"]); ?>" placeholder="请填写专业名称" id="type_name" name="type_name" style="width:250px">
			</div>
		</div>

		<?php if($type['parentID'] != 0): ?><div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>分类名称：</label>
				<div class="formControls col-xs-8 col-sm-9"> 
					<div class="form_control">
						<select id="ParentType" name="parentID" class="input-text" style="width:200px;">
