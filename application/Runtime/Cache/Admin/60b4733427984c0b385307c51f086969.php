	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20"> 
			<span class="l">
				...
				<a class="btn btn-primary radius" onclick="lanmu_add('添加专业','/yixue/admin.php/Type_add.html')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加分类</a>
				<a class="btn btn-primary radius" onclick="lanmu_add('添加专业','/yixue/admin.php/Special_add.html')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加专业</a>
			...
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				<thead>
					<tr class="text-c">
						...
						<th width="100">排序ID</br>(点击数字排序)</th>
						<th width="100">操作</th>
					</tr>
				</thead>
				<tbody>
