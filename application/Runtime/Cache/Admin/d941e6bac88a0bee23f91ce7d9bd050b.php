	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20"> 
			<span class="l">
				...
				<a class="btn btn-primary radius" onclick="class_add('添加课程','/yixue/admin.php/Shiti_add.html')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加试题</a>
			</span> 
		...
		<div class="mt-20">
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<tbody>
					<?php if(is_array($shiti)): $i = 0; $__LIST__ = $shiti;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shiti): $mod = ($i % 2 );++$i;?><tr>
							<td style="text-align: center"><input type="checkbox" value="<?php echo ($shiti["id"]); ?>" name="id"></td>
							<td style="text-align: center"><?php echo ($shiti["id"]); ?></td>
							<td style="text-align: center"><?php echo ($shiti["question"]); ?></td>
							<td style="text-align: center"><?php echo ($shiti["specialty"]); ?></td>
							<td style="text-align: center"><?php echo (msubstr($shiti["list"],0,20)); ?></td>
							<td style="text-align: center"><?php echo (msubstr($shiti["content"],0,20)); ?></td>
							<td style="text-align: center"><a style='text-decoration:none' href='javascript:void(0)'  title='编辑' onclick="product_show('课程编辑','/yixue/admin.php/Shiti_edit_<?php echo ($shiti["id"]); ?>',<?php echo ($shiti["id"]); ?>)")>编辑</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a style='text-decoration:none' href='javascript:void(0)'  title='删除' onclick="article_del(<?php echo ($shiti["id"]); ?>)")>删除</a></td>
