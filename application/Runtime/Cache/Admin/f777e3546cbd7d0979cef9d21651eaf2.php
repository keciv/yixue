...
<![endif]-->
<title>免费课程类型添加</title>
</head>
<body>
<div class="page-container">
	<form method="post" class="form form-horizontal" id="form-classType-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-6 col-sm-6">
				<input type="text" class="input-text" value="<?php echo ($type["type_name"]); ?>" placeholder="请填写课程类型" id="type_name" name="type_name" style="width:250px">
			</div>
		</div>
...
$(function(){	
	...
	$('#tijiao').click(function(){
		...
		if(caozuo=="add"){
			$('#form-classType-add').attr('action','/yixue/admin.php/ClassTypeAdd/add');
		}else if(caozuo=="edit"){
			$('#form-classType-add').attr('action','/yixue/admin.php/ClassTypeAdd/edit');
		}
