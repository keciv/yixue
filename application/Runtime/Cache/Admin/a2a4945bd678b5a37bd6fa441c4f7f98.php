	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20"> 
			<span class="l">
				...
				<a class="btn btn-primary radius" onclick="news_add('添加文章','/yixue/admin.php/New_add.html')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加文章</a>
			</span> 
		...
		<div class="mt-20">
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<tbody>
					<?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news): $mod = ($i % 2 );++$i;?><tr class="text-c va-m">
							<td><input name="id" type="checkbox" value="<?php echo ($news["id"]); ?>"></td>
							<td><?php echo ($news["id"]); ?></td>
							<td><?php echo ($news["title"]); ?></td>
							<td><?php echo ($news["lanmu_type"]); ?></td>
							<td onclick="sort(<?php echo ($news["SortID"]); ?>,<?php echo ($news["id"]); ?>);"><?php echo ($news["SortID"]); ?></td>
							<td><?php echo ($news["dateandtime"]); ?></td>
								
							<td class="td-manage">
								
								<a style="text-decoration:none" class="ml-5" onClick="news_edit('文章编辑','/yixue/admin.php/New_edit_<?php echo ($news["id"]); ?>.html',<?php echo ($news["id"]); ?>)" href="javascript:;" title="编辑">
									<i class="Hui-iconfont">&#xe6df;</i>
								</a> 
								
								<a style="text-decoration:none" class="ml-5" onClick="news_delect(<?php echo ($news["id"]); ?>)" href="javascript:;" title="删除">
									<i class="Hui-iconfont">&#xe6e2;</i>
								</a>
							</td>
