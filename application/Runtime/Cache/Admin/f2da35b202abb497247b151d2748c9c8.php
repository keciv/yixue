	...
	<div class="page-container">
		...
		<div class="mt-20">
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<tbody>
					<?php if(is_array($question)): $i = 0; $__LIST__ = $question;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$wenti): $mod = ($i % 2 );++$i;?><tr>
							<td style="text-align: center"><input type="checkbox" value="<?php echo ($wenti["id"]); ?>" name="id"></td>
							<td style="text-align: center"><?php echo ($wenti["id"]); ?></td>
							<td style="text-align: center"><?php echo ($wenti["user"]); ?></td>
							<td style="text-align: center"><?php echo ($wenti["question"]); ?></td>
							<td style="text-align: center"><?php echo ($wenti["content"]); ?></td>
							<td style="text-align: center"><a style='text-decoration:none' href='javascript:void(0)'  title='查看' onclick="product_show('问题详情','/yixue/admin.php/Question_edit_<?php echo ($wenti["id"]); ?>',<?php echo ($wenti["id"]); ?>)")>查看</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a style='text-decoration:none' href='javascript:void(0)'  title='删除' onclick="article_del(<?php echo ($wenti["id"]); ?>)")>删除</a></td>
