...
<div class="page-container">
	<form method="post" class="form form-horizontal" id="form-lanmu-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-6 col-sm-6">
				<input type="text" class="input-text" value="<?php echo ($lanmu["title"]); ?>" placeholder="请填写栏目名称" id="user-name" name="title">
			</div>
		</div>
...
$(function(){	
	...
	$('#tijiao').click(function(){
		...
		if(caozuo=="add"){
			$('#form-lanmu-add').attr('action','/yixue/admin.php/LanmuAdd/lanmu_add');
		}else if(caozuo=="edit"){
			$('#form-lanmu-add').attr('action','/yixue/admin.php/LanmuAdd/lanmu_edit');
		}
		$('#form-lanmu-add').submit();
	})
})
</script>
