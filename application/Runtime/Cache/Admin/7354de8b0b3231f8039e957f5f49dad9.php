	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20"> 
			<span class="l">
				...
				<a class="btn btn-primary radius" onclick="user_add('添加会员','/yixue/admin.php/User_add.html')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加会员</a>
			</span> 
		...
		<div class="mt-20">
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<tbody>
					<?php if(is_array($users)): $i = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><tr class="text-c va-m">
							<td width="40"><input name="id" type="checkbox" value="<?php echo ($user["id"]); ?>"></td>
							...
							<td class="td-manage">
								<a style="text-decoration:none" class="ml-5" onClick="user_edit('文章编辑','/yixue/admin.php/User_edit_<?php echo ($user["id"]); ?>.html',<?php echo ($user["id"]); ?>)" href="javascript:;" title="编辑">
									<i class="Hui-iconfont">&#xe6df;</i>
								</a> 
								
								<a style="text-decoration:none" class="ml-5" onClick="user_delect(<?php echo ($user["id"]); ?>)" href="javascript:;" title="删除">
									<i class="Hui-iconfont">&#xe6e2;</i>
								</a>
							</td>
