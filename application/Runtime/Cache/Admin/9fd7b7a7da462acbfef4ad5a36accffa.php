...
<div class="page-container">
	<form method="post" class="form form-horizontal" id="form-special-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-6 col-sm-6">
				<input type="text" class="input-text" value="<?php echo ($user["name"]); ?>" style="width:250px" readonly="readonly">
			</div>
		</div>


		<div class="row cl">
			<?php if($type != 'yijian'): ?><label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>问题：<?php echo ($type); ?></label>
			<div class="formControls col-xs-6 col-sm-6">
				<input type="text" class="input-text" value="<?php echo ($question["question"]); ?>" style="width:250px" readonly="readonly">
			</div><?php endif; ?>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-6 col-sm-6">
				<textarea type="text" value="<?php echo ($question["question"]); ?>" style="width:250px;height:180px;line-height: 30px" readonly="readonly"><?php echo ($question["content"]); ?></textarea>
			</div>
		</div>
...
$(function(){	
	...
	$('#tijiao').click(function(){
		...
		if(caozuo=="add"){
			$('#form-special-add').attr('action','/yixue/admin.php/SpecialAdd/special_add');
		}else if(caozuo=="edit"){
			$('#form-special-add').attr('action','/yixue/admin.php/SpecialAdd/special_edit');
		}
